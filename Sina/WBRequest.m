...
- (void)handleResponseData:(NSData *)data 
{
    NSLog(@"WBRequest handleResponseData");
...
- (id)parseJSONData:(NSData *)data error:(NSError **)error
{
	...
	id result = [jsonParser objectWithData:data error:&parseError];
...
- (void)failedWithError:(NSError *)error 
{
    NSLog(@"WBRequest failedWithError");
...
{    
    NSLog(@"WBRequest didReceiveResponse");
...
{   
    NSLog(@"WBRequest didReceiveData");
	[responseData appendData:data];
    NSString *string = [[[NSString alloc] initWithData:data encoding:NSUTF8StringEncoding] autorelease];
    NSLog(@"WBRequest didReceiveString: %@", string);
}
...
{   
    NSLog(@"WBRequest connectionDidFinishLoading");
...
{
    NSLog(@"WBRequest didFailWithError");
	[self failedWithError:error];
