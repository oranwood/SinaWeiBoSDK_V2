...
+ (id)share {
    ...
    dispatch_once(&onceToken, ^{
        _sharedEngine = [[WBAuthorize alloc] initWithAppKey:SHKSinaConsumerKey appSecret:SHKSinaSecret];
    });
...
{
    if (redirectURI==nil) redirectURI = @"http://";
    NSDictionary *params = [NSDictionary dictionaryWithObjectsAndKeys:appKey, @"client_id",
...
{
    NSLog(@"WBAuthorize didFinishLoadingWithResult");
    BOOL success = NO;
    if ([result isKindOfClass:[NSDictionary class]])
    {
        ...
        {
            NSLog(@"WBAuthorize delegate didSucceedWithAccessToken");
